...
import (
	...
	jsonparser "github.com/gravwell/jsonparser"
	tar "archive/tar"
	zip "archive/zip"
	bufio "bufio"
	bytes "bytes"
...
func init() {
	packages = make(native.Packages, 136)
	...
	// "crypto/tls"
	decs = make(native.Declarations, 115)
	...
	decs["ECHRejectionError"] = reflect.TypeOf((*tls.ECHRejectionError)(nil)).Elem()
	decs["Ed25519"] = tls.Ed25519
	decs["EncryptedClientHelloKey"] = reflect.TypeOf((*tls.EncryptedClientHelloKey)(nil)).Elem()
	...
	decs["OID"] = reflect.TypeOf((*x509.OID)(nil)).Elem()
	...
	decs["PolicyMapping"] = reflect.TypeOf((*x509.PolicyMapping)(nil)).Elem()
	...
	// "encoding"
	decs = make(native.Declarations, 6)
	decs["BinaryAppender"] = reflect.TypeOf((*encoding.BinaryAppender)(nil)).Elem()
	...
	decs["TextAppender"] = reflect.TypeOf((*encoding.TextAppender)(nil)).Elem()
	...
	decs = make(native.Declarations, 185)
	...
	decs["CONFIRM_DITTO_BLOCK_MAGIC"] = ingest.CONFIRM_DITTO_BLOCK_MAGIC
	...
	decs["ConstraintSpecials"] = &ingest.ConstraintSpecials
	...
	decs["DITTO_BLOCK_MAGIC"] = ingest.DITTO_BLOCK_MAGIC
	...
	decs["ErrInvalidTimeout"] = &ingest.ErrInvalidTimeout
	...
	decs["ErrPendingDittoBlock"] = &ingest.ErrPendingDittoBlock
	...
	decs["ErrTooManyTags"] = &ingest.ErrTooManyTags
	decs["ErrUnderFill"] = &ingest.ErrUnderFill
	decs["ErrUnknownTag"] = &ingest.ErrUnknownTag
	...
	decs["MB"] = ingest.MB
	decs["MINIMUM_DITTO_VERSION"] = ingest.MINIMUM_DITTO_VERSION
	...
	decs = make(native.Declarations, 91)
	...
	// "go/types"
	decs = make(native.Declarations, 153)
	decs["Alias"] = reflect.TypeOf((*types.Alias)(nil)).Elem()
	...
	decs["KeepAliveConfig"] = reflect.TypeOf((*net.KeepAliveConfig)(nil)).Elem()
	...
	// "net/http"
	decs = make(native.Declarations, 184)
	...
	decs["Get"] = http.Get
	decs["HTTP2Config"] = reflect.TypeOf((*http.HTTP2Config)(nil)).Elem()
	...
	decs["Protocols"] = reflect.TypeOf((*http.Protocols)(nil)).Elem()
	...
	decs["Root"] = reflect.TypeOf((*os.Root)(nil)).Elem()
	...
	decs["CrashOptions"] = reflect.TypeOf((*debug.CrashOptions)(nil)).Elem()
